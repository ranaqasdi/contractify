        ...
        <>
            <section className='flex justify-center lg:pt-36 pt-16 pb-16 bg-[url(/images/4.png)] bg-cover bg-no-repeat bg-center'>
                <div className='flex lg:w-[70%] w-[90%] justify-center items-center flex-col gap-y-4'>
                    <h2 className="text-[#5d17eb] font-semibold lg:text-6xl text-4xl text-center" >10+ Templik PDF Templates</h2>
                    <h2 className="text-[#5d17eb] font-medium text-xl text-center">With 10 expertly crafted templates across key industries, Templik gives your business the tools to make an impact.</h2>
                ...
                <div className='flex xl:w-[70%] w-[90%] lg:flex-row flex-col gap-y-10 justify-between gap-x-14'>
                    <div className='flex flex-col gap-y-3 border rounded shadow hover:shadow-lg hover:shadow-purple-100 transition duration-300'>
                        <Link href={"/forms/nda-forms"}>
                            <img className='w-full h-[250px] object-contain object-top' src="/images/nda-form01.png" alt="" />
                    ...
                    <div className='flex flex-col gap-y-3 border rounded shadow hover:shadow-lg hover:shadow-purple-100 transition duration-300'>
                        <Link href={"/forms/employment/1"}>
                            <img className='w-full h-[250px] object-contain object-top' src="/images/Employee01.webp" alt="" />
                            <div className=' py-5 px-6 bg-[#5d17eb15]'>
                    ...
                    <div className='flex flex-col gap-y-3 border rounded shadow hover:shadow-lg hover:shadow-purple-100 transition duration-300'>
                        <Link href={"/forms/influencer-contract/1"}>
                            <img className='w-full h-[250px] object-contain object-top' src="/images/influencer01.webp" alt="" />
                            <div className=' py-5 px-6 bg-[#5d17eb15]'>
                ...
                <div className='flex xl:w-[70%] w-[90%] lg:flex-row flex-col gap-y-10 justify-between gap-x-14 mt-14'>
                    <div className='flex flex-col gap-y-3 border rounded shadow hover:shadow-lg hover:shadow-purple-100 transition duration-300'>
                        <Link href={"/forms/resume/1"}>
                            <img className='w-full h-[250px] object-contain object-top' src="/images/resume01.webp" alt="" />
                            <div className=' py-5 px-6 bg-[#5d17eb15]'>
                    ...
                    <div className='flex flex-col gap-y-3 border rounded shadow hover:shadow-lg hover:shadow-purple-100 transition duration-300'>
                        <Link href={"/forms/lease/1"}>
                            <img className='w-full h-[250px] object-contain object-top' src="/images/lease01.png" alt="" />
                            <div className=' py-5 px-6 bg-[#5d17eb15]'>
                ...
                <div className='flex lg:w-[70%] w-[90%]  lg:flex-row flex-col gap-y-10  justify-between gap-x-14 mt-14'>
                    <div className='flex flex-col gap-y-3 border rounded shadow hover:shadow-lg hover:shadow-purple-100 transition duration-300'>
                        <Link href={"/forms/freelance/1"}>
                            <img className='w-full h-[250px] object-contain object-top' src="/images/freelance01.png" alt="" />
                            <div className=' py-5 px-6 bg-[#5d17eb15]'>
                    ...
                    <div className='flex flex-col gap-y-3 border rounded shadow hover:shadow-lg hover:shadow-purple-100 transition duration-300'>
                        <Link href={"/forms/business/1"}>
                            <img className='w-full h-[250px] object-contain object-top' src="/images/business01.png" alt="" />
                            <div className=' py-5 px-6 bg-[#5d17eb15]'>
                    ...
                    <div className='flex flex-col gap-y-3 border rounded shadow hover:shadow-lg hover:shadow-purple-100 transition duration-300'>
                        <Link href={"/forms/invoice/1"}>
                            <img className='w-full h-[250px] object-contain object-top' src="/images/invoice01.png" alt="" />
                            <div className=' py-5 px-6 bg-[#5d17eb15]'>
                ...
                <div className='flex lg:w-[70%] w-[90%] lg:flex-row flex-col gap-y-10 justify-between gap-x-14 mt-14'>
                    <div className='flex flex-col gap-y-3 border rounded shadow hover:shadow-lg hover:shadow-purple-100 transition duration-300'>
                        <Link href={"/forms/expense/1"}>
                            <img className='w-full h-[250px] object-contain object-top' src="/images/expense01.png" alt="" />
                            <div className=' py-5 px-6 bg-[#5d17eb15]'>
