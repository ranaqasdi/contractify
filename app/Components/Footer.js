        ...
        <footer className="bg-[#5d17eb] text-white pt-10">
            <div className="md:max-w-[70%]  mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="mt-2 space-y-2 text-gray-300">
                        <li><a href="/forms/influencer-contract/1" className="hover:text-gray-200">Influencer Contract</a></li>
                        <li><a href="/forms/resume/1" className="hover:text-gray-200">Resume Templates</a></li>
                        <li><a href="/forms/nda-forms" className="hover:text-gray-200">NDA FORMS</a></li>
                        <li><a href="/forms/lease/1" className="hover:text-gray-200">Property Rental Template</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div className="flex mt-2 space-x-4">
                        ...
                        <a href="#" className="text-gray-100 hover:text-white text-2xl"><FaTwitter /></a>
                        <a href="#" className="text-gray-100 hover:text-white text-2xl"><FaLinkedin /></a>
                    </div>
                </div>
